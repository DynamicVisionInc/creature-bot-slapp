...
//*********************************************
  ...
  app.message('favorite', ['direct_mention', 'direct_message'], (msg, text) => {
    ...
    db.saveFavorite({ 'Book/ Novel' },(err) => {})
    db.saveFavorite({ 'Color' },(err) => {})
    db.saveFavorite({ 'Actor' },(err) => {})
    db.saveFavorite({ 'Hero' },(err) => {})
    db.saveFavorite({ 'Villain' },(err) => {})
    db.saveFavorite({ 'Fruit' },(err) => {})
    db.saveFavorite({ 'Vegetable' },(err) => {})
    db.saveFavorite({ 'Ice Cream' },(err) => {})
    db.saveFavorite({ 'Candy' },(err) => {})
    db.saveFavorite({ 'Restaurant' },(err) => {})
    db.saveFavorite({ 'Article of Clothing' },(err) => {})
    db.saveFavorite({ 'Hair Color' },(err) => {})
    db.saveFavorite({ 'Eye Color' },(err) => {})
    db.saveFavorite({ 'Person' },(err) => {})
    db.saveFavorite({ 'Website' },(err) => {})
    db.saveFavorite({ 'Song' },(err) => {})
    db.saveFavorite({ 'Artist' },(err) => {})
    db.saveFavorite({ 'Game' },(err) => {})
    db.saveFavorite({ 'Board Game' },(err) => {})
    db.saveFavorite({ 'Food' },(err) => {})
    db.saveFavorite({ 'Movie Director' },(err) => {})
    db.saveFavorite({ 'Television Show' },(err) => {})
    db.saveFavorite({ 'Sport' },(err) => {})
    db.saveFavorite({ 'Car' },(err) => {})
    db.saveFavorite({ 'School Subject' },(err) => {})
    db.saveFavorite({ 'Hobby' },(err) => {})
    db.saveFavorite({ 'Music Genre' },(err) => {})
    db.saveFavorite({ 'State' },(err) => {})
    db.saveFavorite({ 'City' },(err) => {})
    db.saveFavorite({ 'Drink' },(err) => {})
    db.saveFavorite({ 'Holiday' },(err) => {})
    db.saveFavorite({ 'Type of Dog' },(err) => {})
    db.saveFavorite({ 'Type of Cat' },(err) => {})
    // Favorite.run(msg)
  })
